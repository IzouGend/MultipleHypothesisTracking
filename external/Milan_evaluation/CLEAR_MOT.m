...
% if ~isempty(intersect(scenario,[195:198]))
%     [a b c]=intersect(stateInfo.frameNums,gtInfo.frameNums)
%     atblown=zeros(length(stateInfo.frameNums),size(alltracked,2));
%     afpblown=zeros(length(stateInfo.frameNums),size(allfalsepos,2));
% %     size(alltracked)
%     
%     atblown(a',:)=alltracked;
%     afpblown(a',:)=allfalsepos;
%     
%     alltracked=atblown; allfalsepos=afpblown;
% %     size(alltracked)
% %     pause
% %     stateInfo.frameNums
% %     gtInfo.frameNums
